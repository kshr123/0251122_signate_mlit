"""
ベースラインモデル訓練スクリプト（exp001_baseline）

この実験専用の訓練スクリプトです。
特徴量エンジニアリングはBlockシステムを使って明示的に記述しています。
"""
...
# 実験固有の前処理（このディレクトリ内）
from preprocessing import preprocess_for_training, ALL_FEATURES, CATEGORICAL_FEATURES
