...
EXP012_FEATURE_COLUMNS: List[str] = [
    # 継承（exp010）
    'lp_area_value',           # 土地価値目安（lp_price × house_area）
    'area_age_category',       # 面積×築年数カテゴリ（0,1,2,3 ← 拡張）
    'area_age_cat_te_pref',    # カテゴリ×都道府県TE
    'area_age_cat_te_youto',   # カテゴリ×用途地域TE
    # 新規（密度特徴量）
    'post_full_count',         # 郵便番号内物件数
    'post_full_density_bin',   # 密度ビン（4カテゴリ）
    'post_full_density_bin_te',  # 密度ビン×TE
]
...
CATEGORICAL_FEATURES: List[str] = [
    ...
    'rosen_name1', 'rosen_name2', 'eki_name1', 'eki_name2',
    # exp012追加
    'post_full_density_bin',
    'area_age_category',
]


# =============================================================================
# 6. 削除特徴量（exp010_1で特定した低重要度35個）
# =============================================================================
