...
from features.blocks.encoding import (
    ...
    TopNCategoryLEBlock,
    MultiKeyTEBlock,
    HierarchicalTargetEncodingBlock,
)
...
# Binning Blocks
from features.blocks.binning import PercentileBinBlock, FixedBinBlock, GroupPercentileBinBlock

# Numeric/Aggregation Blocks (将来追加予定)
...
__all__ = [
    ...
    "OneHotEncodingBlock",
    "TopNCategoryLEBlock",
    # 後方互換エイリアス（非推奨、TargetEncodingBlockを使用してください）
    "MultiKeyTEBlock",
    "HierarchicalTargetEncodingBlock",
    # Dimension Reduction
    "DimensionReductionBlock",
